...
from text_generation import get_llm_response_async
...
set_background(r"C:/Users/Susma/Pictures/Designer.jpeg")
        ...
        if "emergency" in user_input.lower():
            ...
            if emergency_input:
                ...
                async def handle_emergency():
                    ...
                    additional_guidance = await get_llm_response_async(llm_prompt)
